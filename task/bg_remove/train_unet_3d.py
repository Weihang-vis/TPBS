...
from model_bank.network import Network_Uformer_3D_Unet, Network_3D_Unet
...
parser.add_argument('--log_folder', type=str, default='/home/wwh/code/DLT-main/log/bg_remove/unet_3d/exp12_local_normalization_level', help="output directory")
...
parser.add_argument('--train_datasets_size', type=int, default=500, help='datasets size for training')
...
# with open('/home/wwh/code/DLT-main/dataset/train_set_local_level_small.pkl', 'wb') as f:
#     pickle.dump(train_set, f)
# with open('/home/wwh/code/DLT-main/dataset/val_set_local_level_small.pkl', 'wb') as f:
#     pickle.dump(val_set, f)

# load dataset
with open('/home/wwh/code/DLT-main/dataset/train_set_local_level.pkl', 'rb') as f:
    train_set = pickle.load(f)
with open('/home/wwh/code/DLT-main/dataset/val_set_local_level.pkl', 'rb') as f:
...
'''<<<<<<<<<<<<<<<<<<< network >>>>>>>>>>>>>>>>>>>>'''
network = Network_3D_Unet(in_channels=3, out_channels=1, layer_order='cgr', f_maps=16, final_sigmoid=True)
...
lr_scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer=optimizer, max_lr=10 * opt.lr,
                                                   total_steps=total_steps, div_factor=25., pct_start=0.10)
...
# val_patches = next(iter(val_loader))
callbacks = [
