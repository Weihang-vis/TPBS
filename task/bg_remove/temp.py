...
parser.add_argument('--log_folder', type=str, default='/home/wwh/code/DLT-main/log/bg_remove/uformer_unet_3d/exp13_local_normalization_level_32fm_bigdata', help="output directory")
...
parser.add_argument('--train_datasets_size', type=int, default=2500, help='datasets size for training')
parser.add_argument('--val_datasets_size', type=int, default=200, help='datasets size for training')
parser.add_argument('--train_stack_num', type=int, default=40, help='number of videos for training')
...
with open('/home/wwh/code/DLT-main/dataset/train_set_local_level_large.pkl', 'wb') as f:
    pickle.dump(train_set, f)
with open('/home/wwh/code/DLT-main/dataset/val_set_local_level_large.pkl', 'wb') as f:
...
'''<<<<<<<<<<<<<<<<<<< network >>>>>>>>>>>>>>>>>>>>'''
network = Network_Uformer_3D_Unet(in_channels=3, out_channels=1, f_maps=32, layer_order='cgr', final_sigmoid=True)
