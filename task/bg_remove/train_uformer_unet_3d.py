...
parser.add_argument('--log_folder', type=str, default='/home/wwh/code/DLT-main/log/bg_remove/uformer_unet_3d/exp17_local_normalization_level', help="output directory")
...
parser.add_argument('--train_stack_num', type=int, default=25, help='number of videos for training')
...
# with open('/home/wwh/code/DLT-main/dataset/train_set_local_level.pkl', 'wb') as f:
#     pickle.dump(train_set, f)
# with open('/home/wwh/code/DLT-main/dataset/val_set_local_level.pkl', 'wb') as f:
