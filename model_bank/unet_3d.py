...
class UNet3D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, f_maps=64, layer_order='cgr', num_groups=8, **kwargs):
...
if __name__ == '__main__':
    ...
    model = UNet3D(in_channels=1, out_channels=1, layer_order='cgr', f_maps=16, final_sigmoid=True)
    model.cuda()
    summary(model, (1, 64, 256, 256))
